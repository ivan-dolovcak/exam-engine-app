...
const LANG = [
    ...
    "documentSubmissions" => "Rješenja dokumenata",
    "submissionDate" => "Datum predaje",
    "noSubmissions" => "Ovaj dokument nema predanih rješenja.",
    "viewSubmission" => "Vidi rješenje",
    "view" => "Vidi",
    ...
    "singleChoice" => "Jedan točan",
    "multiChoice" => "Više točnih",
    "shortAnswer" => "Kratak odgovor",
    "fillIn" => "Nadopuna",
];
